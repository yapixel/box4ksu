...
# 重启服务
/data/adb/sing-box/box.sh restart

# 查看状态
/data/adb/sing-box/box.sh status

# 校验配置
/data/adb/sing-box/box.sh check

# 查看脚本日志
/data/adb/sing-box/box.sh log
/data/adb/sing-box/box.sh log 20   # 显示最后20行

# 查看 sing-box 版本
/data/adb/sing-box/box.sh version

# 显示帮助
/data/adb/sing-box/box.sh help
```
